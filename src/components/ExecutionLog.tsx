    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] text-gray-600 tabular-nums">{filtered.length} runs</span>
        </div>
      ...
      {filtered.length === 0 ? (
        <div className="text-center text-gray-600 py-12 text-sm">
          ...
          <p className="text-[10px] text-gray-700 mt-1">
            {filter !== "all" ? "Try switching to \"All\" filter" : "Runs will appear after the first execution"}
          </p>
        </div>
      ) : (
